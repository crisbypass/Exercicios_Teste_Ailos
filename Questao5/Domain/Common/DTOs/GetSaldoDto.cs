namespace Questao5.Domain.Common.DTOs
{
    ...
    [Serializable]
    public class GetSaldoDto(Guid idContaCorrente, string nomeTitular, DateTime dataConsulta, double saldo)
    {
        public Guid IdContaCorrente { get; set; } = idContaCorrente;
